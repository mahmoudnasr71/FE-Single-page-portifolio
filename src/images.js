import project1 from "./images/thumbnail-project-1-large.webp";
import project2 from "./images/thumbnail-project-2-large.webp";
import project3 from "./images/thumbnail-project-3-large.webp";
import project4 from "./images/thumbnail-project-4-large.webp";
import project5 from "./images/thumbnail-project-5-large.webp";
import project6 from "./images/thumbnail-project-6-large.webp";
...
function FrontEndMentorSVG({ className }) {
  return (
    <svg
      viewBox="0 0 24 24"
      className={className}
